                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('two-factor.login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="code" type="password" class="form-control @error('code') is-invalid @enderror" name="code" required>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('two-factor.login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="recovery_code" type="password" class="form-control @error('recovery_code') is-invalid @enderror" name="recovery_code" required>
